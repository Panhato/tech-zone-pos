...
<?php $__env->startSection('title', 'គ្រប់គ្រងតំណែង | Admin'); ?>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-all">
                        <td class="px-8 py-5 text-gray-400 font-medium text-xs">#<?php echo e($pos->id); ?></td>
                        <td class="px-8 py-5 font-bold text-slate-800"><?php echo e($pos->name); ?></td>
                        <td class="px-8 py-5 text-sm text-gray-500"><?php echo e($pos->description ?? '---'); ?></td>
                        <td class="px-8 py-5 text-right flex justify-end gap-3">
                            ...
                            <form action="<?php echo e(route('admin.positions.destroy', $pos->id)); ?>" method="POST" onsubmit="return confirm('តើអ្នកពិតជាចង់លុបតំណែងនេះឬ?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/admin/positions/index.blade.php ENDPATH**/ ?>