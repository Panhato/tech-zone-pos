        ...
        <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
            <div class="w-full md:w-1/3 bg-slate-900 p-10 flex flex-col items-center justify-center text-white">
                <div class="relative group">
                    <img src="<?php echo e($user->avatar ? asset('storage/avatars/'.$user->avatar) : 'https://ui-avatars.com/api/?name='.$user->name); ?>" 
                         class="w-40 h-40 rounded-full object-cover border-4 border-blue-500 shadow-2xl">
                </div>
                <h2 class="mt-6 text-2xl font-bold"><?php echo e($user->name); ?></h2>
                <p class="text-blue-300 text-sm italic">សមាជិកតាំងពី៖ <?php echo e($user->created_at->format('M Y')); ?></p>
            </div>
            ...
            <div class="w-full md:w-2/3 p-10">
                ...
                <?php if(session('success')): ?>
                    <div class="mb-6 p-4 bg-green-100 text-green-700 rounded-xl"><?php echo e(session('success')); ?></div>
                <?php endif; ?>
                ...
                <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e($user->name); ?>" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none">
                        </div>

                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-gray-400">អ៊ីមែល (មិនអាចកែបាន)</label>
                            <input type="email" value="<?php echo e($user->email); ?>" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl cursor-not-allowed">
                        </div>

                        <div>
                            <label class="block text-gray-700 font-semibold mb-2">លេខទូរស័ព្ទ</label>
                            <input type="text" name="phone" value="<?php echo e($user->phone); ?>" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none">
                        </div>
...
</html><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/profile/index.blade.php ENDPATH**/ ?>