...
<?php $__env->startSection('title', 'កែប្រែទំនិញ | Admin Dashboard'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-gray-500 mt-1">កែប្រែព័ត៌មានសម្រាប់៖ <span class="font-bold text-blue-600"><?php echo e($product->name); ?></span></p>
            </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
            <form action="<?php echo e(route('admin.products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8 md:p-12">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="qty" value="<?php echo e(old('qty', $product->qty)); ?>" 
                               class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium" required>
                    </div>
                    ...
                    <div class="col-span-full space-y-4">
                        ...
                        <?php if($product->image): ?>
                            <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                <img src="<?php echo e(asset('storage/products/' . $product->image)); ?>" class="w-20 h-20 object-contain rounded-lg bg-white border border-gray-200 p-1">
                                <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="discount_end_date" 
                                       value="<?php echo e(old('discount_end_date', $product->discount_end_date)); ?>" 
                    ...
                    <div class="col-span-full space-y-2">
                        ...
                        <textarea name="description" rows="4" 
                                  class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium"><?php echo e(old('description', $product->description)); ?></textarea>
                    </div>
                </div>
                ...
                <div class="mt-12 flex flex-col md:flex-row gap-4 border-t border-gray-50 pt-8">
                    ...
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="px-8 py-4 bg-gray-100 text-gray-500 rounded-2xl font-black hover:bg-gray-200 transition-all text-center">
                        បោះបង់
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>