...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <nav class="fixed w-full z-50 top-0 bg-white/90 backdrop-blur-md shadow-sm">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="<?php echo e(route('shop.index')); ?>" class="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                <i class="fas fa-microchip"></i> TECH ZONE
            </a>
            <a href="<?php echo e(route('shop.index')); ?>" class="text-gray-500 hover:text-blue-600">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100 mt-16">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                        ...
                        class="w-full pl-10 pr-4 py-3 border <?php echo e($errors->has('email') ? 'border-red-500' : 'border-gray-300'); ?> rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition bg-gray-50">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="password" id="password" name="password" required
                        placeholder="••••••••" 
                        class="w-full pl-10 pr-4 py-3 border <?php echo e($errors->has('password') ? 'border-red-500' : 'border-gray-300'); ?> rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition bg-gray-50">
                </div>
            </div>
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
            មិនទាន់មានគណនីមែនទេ? 
            <a href="<?php echo e(route('register')); ?>" class="text-blue-600 font-bold hover:underline">ចុះឈ្មោះបង្កើតថ្មី</a>
        </div>
    </div>

</body>
</html><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/auth/login.blade.php ENDPATH**/ ?>