...
<?php $__env->startSection('title', 'Customers List | Admin'); ?>
        ...
        <div class="flex gap-4">
            <div class="bg-white px-6 py-3 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-lg font-black text-slate-800 italic"><?php echo e($customers->count()); ?></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr class="group hover:bg-slate-50/30 transition-all duration-300">
                        ...
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-black text-slate-800 uppercase italic tracking-tight group-hover:text-blue-600 transition-colors"><?php echo e($customer->name); ?></p>
                                    <p class="text-[9px] font-black text-slate-300 uppercase tracking-widest mt-0.5">Customer ID: #<?php echo e($customer->id); ?></p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-2 text-slate-500">
                                ...
                                <span class="text-sm font-bold tracking-tighter"><?php echo e($customer->email); ?></span>
                            </div>
                        </td>
                        ...
                        <td class="px-8 py-5 text-center">
                            <div class="inline-flex flex-col items-center">
                                <span class="px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all
                                    <?php if($customer->orders_count > 0): ?> bg-emerald-50 text-emerald-600 border border-emerald-100
                                    <?php else: ?> bg-slate-50 text-slate-400 border border-slate-100 <?php endif; ?>">
                                    <?php echo e($customer->orders_count); ?> Orders
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="px-8 py-5 text-right">
                            <a href="<?php echo e(route('admin.customers.show', $customer->id)); ?>" class="inline-flex items-center gap-2 bg-slate-900 text-white px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-100 transition-all active:scale-95 group/btn">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>