    ...
    <div class="container mx-auto px-6 pt-32 pb-20">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                ...
                <p class="text-gray-500">អ្នកមានទំនិញចំនួន <span class="font-bold text-blue-600"><?php echo e(count((array) session('cart'))); ?></span> នៅក្នុងកន្ត្រក</p>
            </div>
            <a href="<?php echo e(route('order.history')); ?>" class="flex items-center gap-2 bg-white border border-gray-200 px-4 py-2 rounded-xl text-blue-600 hover:bg-blue-50 transition shadow-sm font-semibold text-sm">
            ...
            <div class="w-full lg:w-3/4">
                <?php if(session('cart') && count(session('cart')) > 0): ?>
                        ...
                        <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 p-6 items-center border-b border-gray-50 hover:bg-blue-50/20 transition-colors">
                                ...
                                <div class="col-span-6 flex items-center gap-4">
                                    <div class="w-24 h-24 bg-white border border-gray-100 rounded-2xl flex items-center justify-center p-2 flex-shrink-0 shadow-sm">
                                        ...
                                        <?php if(!empty($details['image'])): ?>
                                            <img src="<?php echo e(asset('storage/products/' . $details['image'])); ?>" 
                                                 class="w-full h-full object-contain rounded-lg"
                                                 onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($details['name'])); ?>&background=F3F4F6&color=9CA3AF&size=128';">
                                        <?php else: ?>
                                    ...
                                    <div class="flex-grow">
                                        <h3 class="font-bold text-slate-900 leading-snug hover:text-blue-600 transition"><?php echo e($details['name']); ?></h3>
                                        <span class="text-[10px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded uppercase font-bold tracking-tighter"><?php echo e($details['brand'] ?? 'Device'); ?></span>
                                        
                                        <form action="<?php echo e(route('remove_from_cart')); ?>" method="POST" class="mt-3">
                                ...
                                <div class="col-span-2 text-center">
                                    ...
                                    <span class="font-semibold text-gray-600">$<?php echo e(number_format($details['price'], 2)); ?></span>
                                </div>

                                <div class="col-span-2 flex justify-center">
                                    <div class="flex items-center bg-gray-100 rounded-xl px-4 py-1.5">
                                        <span class="text-sm font-bold text-gray-700"><?php echo e($details['quantity']); ?></span>
                                    </div>
                                </div>

                                <div class="col-span-2 text-right">
                                    <span class="md:hidden text-xs text-gray-400">សរុប: </span>
                                    <span class="font-bold text-blue-600 text-lg">$<?php echo e(number_format($details['price'] * $details['quantity'], 2)); ?></span>
                                </div>
                            </div>
                    ...
                    <div class="mt-8 flex justify-between items-center">
                        <a href="<?php echo e(route('shop.index')); ?>" class="group flex items-center gap-2 text-gray-600 hover:text-blue-600 font-bold transition">
                ...
                <?php else: ?>
                    <div class="text-center py-24 bg-white rounded-3xl shadow-sm border border-gray-100">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="bg-blue-600 text-white px-10 py-4 rounded-2xl font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 transition transform hover:-translate-y-1 inline-flex items-center gap-3">
                ...
                <div class="bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 sticky top-24">
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex justify-between text-gray-500">
                            ...
                            <span class="font-bold text-slate-700">$<?php echo e(number_format($total ?? 0, 2)); ?></span>
                        </div>
                        <div class="flex justify-between text-gray-500">
                        ...
                        <div class="flex justify-between items-center text-slate-900">
                            ...
                            <span class="text-2xl font-extrabold text-blue-600 tracking-tight">$<?php echo e(number_format($total ?? 0, 2)); ?></span>
                        </div>
                    </div>
                    
                    <?php if(isset($total) && $total > 0): ?>
                        <a href="<?php echo e(route('checkout.show')); ?>" class="group block w-full text-center bg-slate-900 text-white py-4 rounded-2xl font-bold hover:bg-blue-700 hover:shadow-2xl shadow-lg transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3">
...
</html><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/cart.blade.php ENDPATH**/ ?>