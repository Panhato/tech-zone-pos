                    ...
                    <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-wrap justify-between items-center">
                        <div class="flex gap-6 text-sm">
                            <div>
                                ...
                                <p class="font-bold text-slate-900">#ORD-<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?></p>
                            </div>
                            <div>
                                <p class="text-gray-500 mb-1">កាលបរិច្ឆេទ</p>
                                <p class="font-medium"><?php echo e($order->created_at->format('d M Y, h:i A')); ?></p>
                            </div>
                            <div>
                        ...
                        <div class="flex items-center gap-4 mt-4 md:mt-0">
                            ...
                            <span class="text-xl font-bold text-blue-600">$<?php echo e(number_format($order->total_price, 2)); ?></span>
                        </div>
                    </div>
                            ...
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 last:border-0">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">x <?php echo e($item->quantity); ?></p>
                                    </div>
                                </div>
...
</html><?php /**PATH C:\Users\ASUS ROG\computer-shop\resources\views/orders/history.blade.php ENDPATH**/ ?>