...
<body class="bg-white text-gray-800">
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap items-center mt-32">
                <div class="w-full md:w-5/12 px-4 mr-auto ml-auto mb-8 md:mb-0">
                    ...
                    <a href="{{ route('shop.index') }}" class="font-bold text-blue-600 hover:text-blue-800 mt-8">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-700 py-16">
        <div class="container mx-auto px-6 text-center">
            ...
            <a href="{{ route('shop.index') }}" class="bg-white text-blue-700 px-8 py-3 rounded-full font-bold shadow-lg hover:bg-gray-100 transition transform hover:scale-105 inline-block">
